...
def init_db():
    ...
    """)
    # Sécurité pour mettre à jour la BDD si elle existe déjà
    try: cursor.execute("ALTER TABLE chantiers ADD COLUMN jours INTEGER DEFAULT 1")
    except sqlite3.OperationalError: pass
    try: cursor.execute("ALTER TABLE chantiers ADD COLUMN gain_par_jour REAL DEFAULT 0")
    except sqlite3.OperationalError: pass
    try: cursor.execute("ALTER TABLE chantiers ADD COLUMN roi_par_jour REAL DEFAULT 0")
    except sqlite3.OperationalError: pass
    conn.commit()
    conn.close()
...
CATALOGUE_CHANTIERS = {
    ...
    "Goudronnage d'une route (112 629 €)": {
        "revenus": 112629, "jours": 10, "location": 0, "sable": 200, "terre": 0, "enrobe": 300, "armature": 0, "tole": 0, "beton": 0, "panneaux": 4, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 10, "jh_ouvrier": 30, "jh_cond": 15,
        "engins_requis": [
    ...
    "Déblayer - Niveau 2 (6 596 €)": {
        "revenus": 6596, "jours": 3, "location": 0, "sable": 0, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 2, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 3, "jh_ouvrier": 6, "jh_cond": 6,
        "engins_requis": [
    ...
    "Exhausser un terrain (10 336 €)": {
        "revenus": 10336, "jours": 5, "location": 0, "sable": 20, "terre": 80, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 5, "jh_ouvrier": 10, "jh_cond": 10,
        "engins_requis": [
    ...
    "Exhausser un terrain (8 908 €)": {
        "revenus": 8908, "jours": 4, "location": 0, "sable": 15, "terre": 60, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 4, "jh_ouvrier": 8, "jh_cond": 8,
        "engins_requis": [
    ...
    "Construction d'un hangar (129 306 €)": {
        "revenus": 129306, "jours": 20, "location": 0, "sable": 40, "terre": 0, "enrobe": 0, "armature": 50, "tole": 100, "beton": 80, "panneaux": 0, "tuyaux": 12, "canalisations": 10, "poutres": 25, "jh_chef": 20, "jh_ouvrier": 80, "jh_cond": 20,
        "engins_requis": [
    ...
    "Suppression d'un espace vert (18 786 €)": {
        "revenus": 18786, "jours": 6, "location": 0, "sable": 0, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 2, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 6, "jh_ouvrier": 18, "jh_cond": 6,
        "engins_requis": [
    ...
    "Compacter - Niveau 2 (3 699 €)": {
        "revenus": 3699, "jours": 2, "location": 0, "sable": 0, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 2, "jh_ouvrier": 2, "jh_cond": 4,
        "engins_requis": [
            {"N° Étape": 1, "Durée Étape (jours)": 2, "Type d'engin requis": "Compacteurs de Sol", "Niveau requis": "N2"}
        ]
    },
    "Goudronnage d'un chemin (34 960 €)": {
        "revenus": 34960, "jours": 5, "location": 0, "sable": 50, "terre": 0, "enrobe": 90, "armature": 0, "tole": 0, "beton": 0, "panneaux": 2, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 5, "jh_ouvrier": 15, "jh_cond": 10,
        "engins_requis": [
    ...
    "Exhausser un terrain (6 664 €)": {
        "revenus": 6664, "jours": 3, "location": 0, "sable": 10, "terre": 40, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 3, "jh_ouvrier": 6, "jh_cond": 6,
        "engins_requis": [
            {"N° Étape": 1, "Durée Étape (jours)": 3, "Type d'engin requis": "Chargeuse", "Niveau requis": "N2"}
        ]
    },
    "Déblayer - Niveau 3 (21 528 €)": {
        "revenus": 21528, "jours": 7, "location": 0, "sable": 0, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 4, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 7, "jh_ouvrier": 21, "jh_cond": 14,
        "engins_requis": [
    ...
    "Assainissement de lit (Petit cours d'eau) (12 180 €)": {
        "revenus": 12180, "jours": 4, "location": 0, "sable": 10, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 15, "panneaux": 2, "tuyaux": 0, "canalisations": 8, "poutres": 0, "jh_chef": 4, "jh_ouvrier": 12, "jh_cond": 4,
        "engins_requis": [
            {"N° Étape": 1, "Durée Étape (jours)": 2, "Type d'engin requis": "Pelleteuses", "Niveau requis": "N2"},
    ...
    "Assainissement de lit (Cours d'eau) (10 450 €)": {
        "revenus": 10450, "jours": 4, "location": 0, "sable": 8, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 10, "panneaux": 2, "tuyaux": 0, "canalisations": 6, "poutres": 0, "jh_chef": 4, "jh_ouvrier": 12, "jh_cond": 4,
        "engins_requis": [
    ...
    "Goudronnage d'une route (Grande surface) (214 599 €)": {
        "revenus": 214599, "jours": 16, "location": 0, "sable": 488, "terre": 0, "enrobe": 618, "armature": 0, "tole": 0, "beton": 0, "panneaux": 6, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 16, "jh_ouvrier": 48, "jh_cond": 28,
        "engins_requis": [
            {"N° Étape": 1, "Durée Étape (jours)": 4, "Type d'engin requis": "Pelleteuses", "Niveau requis": "N2"},
    ...
    "Construction d'un hangar (139 104 €)": {
        "revenus": 139104, "jours": 22, "location": 0, "sable": 45, "terre": 0, "enrobe": 0, "armature": 60, "tole": 120, "beton": 90, "panneaux": 0, "tuyaux": 16, "canalisations": 12, "poutres": 30, "jh_chef": 22, "jh_ouvrier": 90, "jh_cond": 22,
        "engins_requis": [
    ...
    "Compacter - Niveau 2 (4 617 €)": {
        "revenus": 4617, "jours": 3, "location": 0, "sable": 0, "terre": 0, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 3, "jh_ouvrier": 3, "jh_cond": 6,
        "engins_requis": [
            {"N° Étape": 1, "Durée Étape (jours)": 3, "Type d'engin requis": "Compacteurs de Sol", "Niveau requis": "N2"}
        ]
    },
    "Remblayer - Niveau 3 (13 674 €)": {
        "revenus": 13674, "jours": 5, "location": 0, "sable": 10, "terre": 120, "enrobe": 0, "armature": 0, "tole": 0, "beton": 0, "panneaux": 0, "tuyaux": 0, "canalisations": 0, "poutres": 0, "jh_chef": 5, "jh_ouvrier": 15, "jh_cond": 10,
        "engins_requis": [
...
# --- CATALOGUE COMPLET DES ENGINS DISPONIBLES ---
CATALOGUE_ENGINS = {
    "Camion Benne N1 - Iveco Daily (180 cv)": 200, "Camion Benne N1 - Renault Master 3 (160 cv)": 200, "Camion Benne N3 - Renault Trucks K 430 (430 cv)": 420,
    "Pelleteuse N1 - CAT 301.8 (15.7 kW)": 150, "Pelleteuse N1 - CAT 303 CR (17.6 kW)": 150, "Pelleteuse N1 - Kubota KX019-4 (11.6 kW)": 150, "Pelleteuse N1 - Kubota KX030-4 (17.7 kW)": 150, "Pelleteuse N1 - Takeuchi TB225 (16.5 kW)": 150, "Pelleteuse N1 - Takeuchi TB325R (16.5 kW)": 150,
    "Pelleteuse N2 - CAT 317 GC (89 kW)": 200, "Pelleteuse N2 - Takeuchi TB2150 (85.0 kW)": 200, "Pelleteuse N2 - CAT 315 GC (73.3 kW)": 200, "Pelleteuse N3 - CAT 330 (203.7 kW)": 280, "Pelleteuse N3 - CAT 336 (223.5 kW)": 280, "Pelleteuse N4 - Hitachi ZX490LCH-7 (296 kW)": 450, "Pelleteuse N4 - CAT 350 (308 kW)": 450,
    "Compacteur Sol N2 - CAT CS11 GC (91.7 kW)": 280, "Compacteur Sol N2 - Dynapac CA1300D (55 kW)": 280, "Compacteur Sol N3 - CAT CS19 (130.4 kW)": 340, "Compacteur Sol N3 - Dynapac CA6500D (149 kW)": 340,
    "Compacteur Enrobé N1 - CAT CB1.8 (N/A)": 220, "Compacteur Enrobé N1 - Dynapac CC1000 e (11 kW)": 220, "Compacteur Enrobé N2 - CAT CC2.7 (N/A)": 280, "Compacteur Enrobé N2 - Dynapac CC1400 VI (35 kW)": 280, "Compacteur Enrobé N3 - CAT CB8 (N/A)": 340, "Compacteur Enrobé N3 - Dynapac CC4200 VI (100 kW)": 340,
    "Finisseur N2 - CAT AP455 (90 kW)": 425, "Finisseur N3 - CAT AP600 (129 kW)": 490, "Finisseur N3 - Dynapac SD2500CS (142 kW)": 490,
    "Camion Béton Malaxeur N3 - Renault Trucks C XLOAD (380 cv)": 410, "Camion Pompe à béton N4 - Mecbo ATB 30 (400 cv)": 490,
    "Chargeuse Compacte N2 - CAT 249D3 (50.1 kW)": 360, "Chargeuse Compacte N2 - Bobcat S510 (34.4 kW)": 360, "Chargeuse Compacte N3 - CAT 299D3 XE (82 kW)": 430, "Chargeuse Compacte N3 - Bobcat S770 (68.6 kW)": 430,
    "Chargeuse Pneu N2 - Kubota RT160-2 (26 cv)": 490, "Chargeuse Pneu N2 - Kubota R070 (37.4 kW)": 490, "Chargeuse Pneu N2 - CAT 930 (127 kW)": 490, "Chargeuse Pneu N2 - Hitachi ZW75-6 (50 kW)": 490, "Chargeuse Pneu N3 - CAT GC 966 (239 kW)": 430, "Chargeuse Pneu N3 - Hitachi ZW310-7 (233 kW)": 430, "Chargeuse Pneu N4 - CAT 988 GC (335 kW)": 540,
    "Chargeur Téléscopique N2 - JCB 25-60 Hi-Viz (55 kW)": 220, "Chargeur Téléscopique N3 - JCB 541-70 (81 kW)": 330,
    "Niveleuse N2 - CAT 14 (178 kW)": 580, "Niveleuse N4 - CAT 24 (399 kW)": 680, "Fraiseuse N2 - CAT PM312 (256 kW)": 380, "Fraiseuse N4 - CAT PM825 (601 kW)": 580
}
...
if element_defaut in liste_complete: liste_complete.remove(element_defaut)
...
with onglet1:
    ...
    with col2:
        ...
        px_chef = st.number_input("Coût journalier Chef (€/jour) :", value=230)
        jh_chef = st.number_input("Total Jours-Homme Chef :", value=donnees_modele["jh_chef"])
        
        px_ouvrier = st.number_input("Coût journalier Ouvrier (€/jour) :", value=230)
        jh_ouvrier = st.number_input("Total Jours-Homme Ouvrier :", value=donnees_modele["jh_ouvrier"])
        
        px_cond = st.number_input("Coût journalier Conducteur (€/jour) :", value=230)
        ...
        sal_chef_direct = jh_chef * px_chef
        sal_ouvrier_direct = jh_ouvrier * px_ouvrier
        sal_cond_direct = jh_cond * px_cond
        sal_interim_direct = jh_interim * px_interim
        total_salaires_direct = float(sal_chef_direct + sal_ouvrier_direct + sal_cond_direct + sal_interim_direct)
        ...
        if not engins_necessaires.empty:
            ...
            for _, row in df_coches.iterrows():
                ...
                for engin_nom, prix in CATALOGUE_ENGINS.items():
                    if niveau_demande.lower() in engin_nom.lower():
                ...
                if not modele_trouve:
                    for engin_nom, prix in CATALOGUE_ENGINS.items():
                        if len(mots_cles_recherche) > 0 and mots_cles_recherche in engin_nom.lower():
                            modele_trouve, prix_trouve = engin_nom, prix
                            break
                if modele_trouve:
    ...
    # --- RÉCAPITULATIF TOTAL AVEC LES RAPPORTS JOURNALIERS ---
    st.markdown("---")
...
with onglet2:
    ...
    if df_affichage.empty:
        ...
        # --- LOGIQUE DE COMPARAISON AVEC LES AUTRES CHANTIERS ---
...
# --- NOUVEL ONGLET : ESPACE DIRECTION SÉCURISÉ ---
with onglet3:
    ...
    if mot_de_passe == "adminBTP2026":
        st.success("🔓 Accès accordé. Extraction des indicateurs de performance globale...")
        df_stats = charger_donnees()
        
        if df_stats.empty:
            st.info("Aucune donnée disponible. Enregistrez d'abord des chantiers pour générer le bilan comptable.")
        else:
            ...
            with c_st1:
                st.metric(label="💼 Chantiers Signés", value=f"{total_chantiers}")
            with c_st2:
                st.metric(label="💰 Chiffre d'Affaires Cumulé", value=f"{txt_total_rev} €")
            with c_st3:
                st.metric(label="📉 Dépenses Totales", value=f"{txt_total_dep} €")
            with c_st4:
                st.metric(label="📈 Résultat Net / Bénéfice", value=f"{txt_total_ben} €")
                
            st.markdown("---")
            st.info(f"📊 **Bilan de performance :** Votre structure dégage un taux de marge ROI moyen de **{roi_global_entreprise:.2f} %** sur l'ensemble des projets clôturés.")
